...
const SITE_LINK: &str = "https://dustloop.com/wiki/api.php?action=cargoquery&format=json&limit=100&tables=MoveData_GBVSR&fields=MoveData_GBVSR.input%2C%20MoveData_GBVSR.name%2C%20MoveData_GBVSR.damage%2C%20MoveData_GBVSR.guard%2C%20MoveData_GBVSR.invuln%2C%20MoveData_GBVSR.startup%2C%20MoveData_GBVSR.active%2C%20MoveData_GBVSR.recovery%2C%20MoveData_GBVSR.onHit%2C%20MoveData_GBVSR.onBlock%2C%20&where=chara%3D%22";
const SITE_HALF: &str =
    "%22&order_by=MoveData_GBVSR.type%20ASC%2C%20MoveData_GBVSR.input%20ASC&utf8=1";
